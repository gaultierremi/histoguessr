...
export default function MultiplayerRoomPage({
  ...
  async function startGame() {
    ...
    if (error || !questions || questions.length === 0) {
      setMessage("Pas assez de questions QCM approuvées disponibles.");
      return;
    }
          ...
          <div className="mt-3 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-gray-400">
                Partage ce code avec tes joueurs. Maximum {room.max_players} participants.
              </p>
            </div>
        ...
        {isHost ? (
          <>
            <p className="mt-2 text-sm text-gray-400">
              Tu es le créateur du salon. Lance la partie quand tout le monde est prêt.
            </p>
          ...
          <div className="mt-6 space-y-3">
                    ...
                    <div
                      ...
                      className={`rounded-xl border px-4 py-3.5 text-sm font-medium ${
                        isCorrectAnswer
                          ...
                          : "border-gray-800 bg-gray-900/40 text-gray-600 opacity-50"
                      }`}
                    >
                      {question.options[index]}
                    </div>
            ...
            {question.explanation && (
              <div className="rounded-2xl border border-gray-800 bg-gray-900 p-4 text-sm text-gray-300">
                <span className="font-black text-white">Explication : </span>
                {question.explanation}
              </div>
            )}
          </div>
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                <div className={index === 0 ? "animate-bounce text-6xl" : "text-5xl"}>
                  {medal}
                </div>
